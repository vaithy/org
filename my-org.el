...
(run-at-time "13:00" 86400 '(lambda () (setq org-habit-show-habits t)))
...
(setq org-todo-keyword-faces
      '(
           ...
           ("NEXT"        :foreground "green1" :weight bold  )
...
(setq org-capture-templates
      (quote (
              ...
              ("o" "Mail" entry (file (concat org-directory "refile.org") )
               "* NEXT %a %?\n" :immediate-finish )
...
(setq org-icalendar-combined-agenda-file "C:/Users/vgovinda/org-files/org.ics")
(setq org-icalendar-store-UID 1)
...
; (defun my-appt-disp-window (min-to-app new-time msg)
  ; (save-window-excursion (shell-command (concat "C:/Vaidy/Tools/winzenity-master/zenity --info --title='Reminder' --text='"msg"' &") nil nil)
; ))


;; org-outlook setup
(require 'org-outlook)
(defcustom org-outlook-location (w32-short-file-name "C:/Program Files (x86)/Microsoft Office/Office15/OUTLOOK.EXE")
